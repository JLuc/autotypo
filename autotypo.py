#!/usr/bin/env python
# -*- coding: utf-8 -*-
# File: autotypo.py - fix a text typography according to french typo rules
 for original autoquote file
# © 2020.06 Creation of autotypo by JLuc 
# Following © 2013 enhancements by JLuc of © 2010 autoquote.py by Gregory Pittman
#
...
- TODO : Spaces are not added outside of the quotes.
(that could be a job for another more general typographic tool)

INSTALL
download file, save it with 'autotypo.py' name
and enjoy
...
if (lang == 'fr'):
    ...
    scribus.messageBox("Done", 'Successfully ran script\n'+str(nbchange)+' replacements have occurred' + debugmessage, # Change this message to your liking
                        icon=scribus.ICON_NONE,button1=scribus.
